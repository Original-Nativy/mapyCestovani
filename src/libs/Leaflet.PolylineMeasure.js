    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        _toggleMeasure: function () {
            ...
            if (this._measuring) {   // if measuring is going to be switched on
                ...
                if(this.options.clearMeasurementsOnStop && this._layerPaint && this.options.hideMeasurements) {
                    this._hideAllMeasurements();}
        ...
        //hide all Measurements from the map
        _hideAllMeasurements: function() {
            if (this._layerPaint) {
